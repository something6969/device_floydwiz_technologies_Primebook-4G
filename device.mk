...
# Seccomp
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/seccomp/android.hardware.media.c2@1.1-default-seccomp_policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/android.hardware.media.c2@1.1-default-seccomp_policy \
...
# Inherit vendor
$(call inherit-product, vendor/floydwiz_technologies/Primebook-4G/Primebook-4G-vendor.mk)